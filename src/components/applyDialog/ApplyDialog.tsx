    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-full lg:max-w-3/4 xl:max-w-3/7 h-[85vh] overflow-auto flex flex-col">
        ...
        <div className="flex flex-col">
          <div className="text-base text-gray-700 font-semibold my-4">
            {' '}
              ...
              <div className="">
                ...
                >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="hover:bg-green-500 text-base bg-gray-300 text-gray-500"
                  >
                    {fileName || 'Chọn CV'}
                  </Button>
                </label>
        ...
        <DialogFooter className="grid grid-cols-1 md:grid-cols-4 gap-3 my-5 ">
          <Button
            className="bg-gray-300 font-semibold text-base py-5 text-black hover:bg-gray-500 md:col-span-1"
          ...
          <Button
            ...
            className=" py-5 text-base md:col-span-3"
          >
            Nộp hồ sơ ứng tuyển
          </Button>
        </DialogFooter>
