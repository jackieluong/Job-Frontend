...
export const posts: Post[] = [
    {
        id: '1',
        title: 'SENIOR FRONTEND /BACKEND / FULLSTACK DEVELOPER ( ReactJS, TypeScript, NodeJS, LARAVEL) ',
        status: 'OPEN',
        deadline: '2025-04-15',
        createdAt: '2025-03-20',
    },
...
<Link href="#" className="text-sm text-gray-500 lg:pr-2 lg:border-r-2">Sửa tin</Link>
        <Link href="#" className="text-sm text-gray-500 lg:pr-2 lg:border-r-2" >Xem chi tiết</Link>
        <Link href="#" className="text-sm text-gray-500 " >Xem danh sách CV</Link>
        </div>
        </div>
      ),
    // maxSize: 300,
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge className={`px-3 py-1 rounded-full ${statusColorMap[status] || "bg-gray-100 text-gray-800"}`}>
