...
export function DataTable<TData, TValue>({ columns, data, total, currentPage, onPageChange, pageSize, onPageSizeChange, pageCount }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="rounded-md border">
     ...
     pageSize={pageSize} onPageSizeChange={onPageSizeChange} pageCount={pageCount}
     />
