...
const categories = [
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/kinh-doanh-ban-hang.png?v=2',
    title: 'Kinh doanh - Bán hàng',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/marketing-truyen-thong-quang-cao.png?v=2',
    title: 'Marketing - PR - Quảng cáo',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/dich-vu-khach-hang.png?v=2',
    title: 'Chăm sóc khách hàng (Customer service)',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/hanh-chinh-van-phong.png?v=2',
    title: 'Nhân sự - Hành chính - Pháp chế',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/ngan-hang-tai-chinh.png?v=2',
    title: 'Tài chính - Ngân hàng - Bảo hiểm',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/cong-nghe-thong-tin.png?v=2',
    title: 'Công nghệ thông tin',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/bat-dong-san.png?v=2',
    title: 'Bất động sản - Xây dựng',
  },
  {
    imgUrl:
      'https://www.topcv.vn/v4/image/welcome/top-categories/ke-toan-kiem-toan.png?v=2',
...
function page() {
  ...
  const paginatedJobs = jobGood?.slice(
  ...
  const handleSearch = () => {
    if (keyword.trim()) {
      ...
      router.push(`job/search?keyword=${keyword}`);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="w-full bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="text-center md:text-left max-w-xl">
              ...
              <p className="text-gray-600 text-base italic">
                “Khi ước mơ nở hoa trên con đường sự nghiệp, hãy đồng hành cùng
                chúng tôi để tạo ra ngọn lửa đam mê và thắp lên cơ hội.”
              </p>
            </div>
          </div>
        </div>
            ...
            >
              {[...jobGood, ...jobGood].map((company, index) => (
                <div
                  ...
                  className="flex-none w-1/3 sm:w-1/5 md:w-1/4 lg:w-1/6 p-2 sm:p-3 md:p-4"
                >
                  <Link
                    href={`/company/${company.companyId}`}
                    className="bg-white w-full h-20 md:h-28 rounded-lg flex justify-center items-center border border-gray-300 hover:border-green-600 p-2 cursor-pointer"
                  >
            ...
            <div className="left-section w-full ">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
                {paginatedJobs?.map((job) => (
                  <div
                    key={job.id}
                    className="w-full bg-white px-2 py-2 border-1 hover:border-1 hover:border-green-500 rounded-lg"
                  >
                    <div className="flex flex-col-1  sm:flex-col-2 md:flex-cols-3 gap-2 mb-1">
                      ...
                      <div className="right-section flex flex-col">
                        <Link
                          href={`/job/${job.id}`}
                          className="text-base font-semibold hover:text-green-600 line-clamp-1"
                        >
                          {job.name}
                        </Link>
                        <Link
                          href={`/company/${job.companyId}`}
                          className="text-base text-gray-600 uppercase line-clamp-1"
                        >
                          {job.companyName}
                        </Link>
                      </div>
                    ...
                    <div className="flex flex-row flex-wrap gap-2">
                      {job?.salaryFrom ? (
                        <div className="h-[fit-content] w-[fit-content] text-xs text-gray-700 font-medium bg-gray-100 px-2 py-1 rounded-full">
                      ...
                      {job?.city?.map((e) => (
                        <div
                          key={e}
                          className="h-[fit-content] w-[fit-content] text-xs text-gray-700 font-medium bg-gray-100 px-2 py-1 rounded-full"
                        >
                          {e}
                        </div>
                      ))}
            ...
            <div className="relative">
              <div className="bg-white story flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-4 w-[95%] xl:w-[90%] mx-auto ">
                ...
                <div className="basis-1/2 text-center lg:text-left lg:pl-6">
                  <div className="text-xl leading-10 mb-4 font-normal">
                    Ở một thế giới nơi những hồ sơ xin việc trôi dạt như lá vàng
                    cuối thu, đã có một miền đất mới xuất hiện - nơi mọi cơ hội
                    nghề nghiệp đều được xếp hàng chờ đón bạn.
                  </div>
                  <div className="text-gray-500 leading-7 mb-4">
                    Ngay cả những kẻ mộng mơ nhất cũng không thể cưỡng lại được
                    sức hút của những công việc đo ni đóng giày cho chính bạn.{' '}
                    <br />
                    Tên miền ấy, đơn giản mà kỳ diệu - chính là nơi hành trình
                    nghề nghiệp bắt đầu bằng một cú nhấp chuột.
                  </div>
                  <div>
                    <Link
                      href="/job/search"
                      className="text-green-300 hover:text-green-500 font-semibold relative after:absolute after:-bottom-2 after:left-0 after:bg-green-300 hover:after:bg-green-500
        ...
        {/* parallax */}
        <div className="mx-auto h-60 md:h-85 w-full  bg-cover bg-fixed bg-center bg-no-repeat shadow-lg bg-[url('/assets/parallax.jpg')]"></div>
        {/* đk */}
